        ...
        return (
            <View style={styles.container}>
                <View style={styles.textContainer}>
                    <Text style={styles.textStyle} >A verification code is sent to your Email</Text>
                ...
                <View style={styles.buttonContainer}>
                    <Button title='Verify Code' disabled={this.state.value == '' ? true : false} loading={this.props.loading} onPress={async () => { await onVerify(value); this.setState({ value: '' }) }} />
                </View>
