...
import { Icon, FloatingInput, Button, DateTime, RadioButton, FooterButton, Input, SearchandMapView } from '../../../components'
                                ...
                                <View>
                                    <TouchableOpacity onPress={() => this.setState({ showDatePicker: true })}>
                                        <View style={[styles.dateContainer,
                                            ...
                                            <View>
                                                <Text style={[styles.dateTextStyle,]}>{date && date != "" ? moment(date).format('Do MMMM YYYY') : "DD/MM/YYYY | Birthday"}</Text>
                                            </View>
